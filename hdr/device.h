...
/* $Logfile:   D:/dos-c/hdr/device.h_v  $ */
#ifdef MAIN
# ifdef VERSION_STRINGS
static BYTE *device_hRcsId = "$Header:   D:/dos-c/hdr/device.h_v   1.4   29 May 1996 21:25:12   patv  $";
# endif
#endif

/*
 * $Log:   D:/dos-c/hdr/device.h_v  $
 *	
...
#define	C_INIT		0		/* Initialize			*/
#define	C_MEDIACHK	1		/* MEDIA Check			*/
#define	C_BLDBPB	2		/* Build BPB			*/
#define	C_IOCTLIN	3		/* Ioctl In			*/
#define	C_INPUT		4		/* Input (Read)			*/
#define	C_NDREAD	5		/* Non-destructive Read		*/
#define	C_ISTAT		6		/* Input Status			*/
#define	C_IFLUSH	7		/* Input Flush			*/
#define	C_OUTPUT	8		/* Output (Write)		*/
#define	C_OUTVFY	9		/* Output with verify		*/
#define	C_OSTAT		10		/* Output			*/
#define	C_OFLUSH	11		/* Output Flush			*/
#define	C_IOCTLOUT	12		/* Ioctl Out			*/
#define	C_OPEN		13		/* Device Open			*/
#define	C_CLOSE		14		/* Device Close			*/
#define	C_REMMEDIA	15		/* Removable MEDIA		*/
#define	C_OUB		16		/* Output till busy		*/
#define	C_GENIOCTL	19		/* Generic Ioctl		*/
#define	C_GETLDEV	23		/* Get Logical Device		*/
#define	C_SETLDEV	24		/* Set Logical Device		*/
