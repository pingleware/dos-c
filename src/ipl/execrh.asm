...
;
; $Logfile:   C:/dos-c/src/ipl/execrh.asv  $
;
; $Header:   C:/dos-c/src/ipl/execrh.asv   1.2   29 Aug 1996 13:06:50   patv  $
;
; $Log:   C:/dos-c/src/ipl/execrh.asv  $
;
;   Rev 1.2   29 Aug 1996 13:06:50   patv
;Bug fixes for v0.91b
;
;   Rev 1.1   01 Sep 1995 17:44:38   patv
;First GPL release.
;
;   Rev 1.0   02 Jul 1995  8:52:22   patv
;Initial revision.
;
