...
;
; $Logfile:   C:/dos-c/src/ipl/stacks.asv  $
;
; $Header:   C:/dos-c/src/ipl/stacks.asv   1.2   29 Aug 1996 13:06:46   patv  $
;
; $Log:   C:/dos-c/src/ipl/stacks.asv  $
;
...
;First GPL release.
;
;   Rev 1.0   02 Jul 1995  8:52:40   patv
;Initial revision.
;
